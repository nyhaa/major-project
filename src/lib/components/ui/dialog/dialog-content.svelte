<script lang="ts">
  ...
  import { cn, flyAndScale } from "$lib/utilities";
...
<Dialog.Portal>
  ...
  <DialogPrimitive.Content
    ...
    {transitionConfig}
    class={cn(
      "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-sm sm:rounded-lg md:w-full",
      className
    )}
    {...$$restProps}>
    <slot />
